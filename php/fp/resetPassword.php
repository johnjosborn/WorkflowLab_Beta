...
if (isset($_POST['ver_email'])){
    ...
    if($result->num_rows == 0){
        ...
        echo "We couldn't find an account for $email.<br>
        ...
        $link = "<a href='http://localhost/workflowlab_beta/php/passwordReset.php?email=$email&t=$hash2'>HERE</a>";
        
        $message = "<html>
                        <body>
                        <img src='cid:logo' width='300'>
                        <br><br>
                        <h4>Thank you for using Workflow Labs.</h4>
                        <br>
                        <h3>Click $link to reset your password.</h3>
                        <br>
                        <h4>Link not working?  Copy and paste this into your browser:<br><h4>
                        <h4>http://localhost/workflowlab_beta/php/passwordReset.php?email=$email&t=$hash2</h4> 
                        </body>
                    </html>";
...
function sendEmail($email, $message){
        ...
        if (!$mail->send()) {
            ...
            echo "We have sent an email to $email.<br>
            Click on the included link to re-set your password.<br>
